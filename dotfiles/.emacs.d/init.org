#+options: toc:2
#+startup: overview
#+title: Emacs 29.4 Configuration
...
#+begin_src emacs-lisp :tangle yes
  ...
  ;; Use Jedi autocompletions.
  ;; 1. Requires epc and auto-complete and ctables
  ;; 2. Requires python venv with dependencies for jediepcserver
  (autoload 'jedi:setup "jedi" nil t)
  ;; Set the following after ~pip install setup.py~
  ...
  ;; (with-eval-after-load 'eglot
  (add-to-list 'eglot-server-programs
               '(python-mode . ("ruff" "server"))) ;; Note: "ruff" "server" can also be used
