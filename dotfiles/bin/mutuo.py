...
def parse_arguments() -> dict:
    ...
    parser.add_argument("--TAN", type=float, required=True, help="TAN in range [0, 100], will be dived by 100.0 by this program")
    parser.add_argument("--TAEG", type=float, required=True, help="TAEG in range [0, 100], will be divied by 100.0 by this program")
